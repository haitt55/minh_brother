                        ...
                        <div class="col-lg-12">
                            <form method="POST" action="{{ route('admin.products.store') }}" role="form" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="number_of_hour" id="number_of_hour" class="form-control" value="{{ old('number_of_hour') }}">
                                </div>
                                <div class="form-group">
                                    <label for="number_of_day">Số buổi học</label>
                                    <input type="text" name="number_of_day" id="number_of_day" class="form-control" value="{{ old('number_of_day') }}">
                                </div>
                                <div class="form-group">
