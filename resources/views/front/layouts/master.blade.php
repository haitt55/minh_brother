					...
					<div class="clearfix">
						...
						<div class="pull-right xs-pull-left">
							<ul class="top_bar_info clearfix">
								...
								<li class="hidden-info"><i class="fa fa-map-marker"></i> Tầng 2, tòa nhà Bách Anh - Số 52 chùa Hà, Cầu Giấy, Hà Nội</li>
								<li class="hidden-info"><i class="fa fa-phone"></i> +84 4 668 41452</li>
							</ul>
						</div>
					</div>
				</div>
								...
								<div class="widget_title"><h3>GIỜ LÀM VIỆC</h3></div>
			        				<table class="table_working_hours">
	        							<tr class="opened">
											...
											<td class="day_value h6">9:00 am - 6.00 pm</td>
										</tr>
										<tr class="opened">
